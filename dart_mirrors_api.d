...
extern (C) Dart_Handle Dart_TypeName(Dart_Handle type);

/**
 * Returns the qualified name for the provided type.
 */
extern (C) Dart_Handle Dart_QualifiedTypeName(Dart_Handle type);
 ...
 */
extern (C) Dart_Handle Dart_GetFunctionNames(Dart_Handle target);
 ...
 */
extern (C) Dart_Handle Dart_LookupFunction(Dart_Handle target, Dart_Handle function_name);
 ...
 *   operation.
 */
extern (C) Dart_Handle Dart_FunctionName(Dart_Handle funct);
 ...
 */
extern (C) Dart_Handle Dart_FunctionOwner(Dart_Handle funct);
 ...
 */
extern (C) Dart_Handle Dart_FunctionIsStatic(Dart_Handle funct,bool* is_static);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_FunctionIsConstructor(Dart_Handle funct,bool* is_constructor);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_FunctionIsGetter(Dart_Handle funct,bool* is_getter);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_FunctionIsSetter(Dart_Handle funct,bool* is_setter);

/**
 * Returns the name of a library as declared in the #library directive.
 */
extern (C) Dart_Handle Dart_LibraryName(Dart_Handle library);
 ...
 *   Otherwise an error handle is returned.
 */
extern (C) Dart_Handle Dart_LibraryGetClassNames(Dart_Handle library);
 ...
 */
extern (C) Dart_Handle Dart_ClosureFunction(Dart_Handle closure);
