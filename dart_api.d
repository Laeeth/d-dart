 ...
 *
 * Hacked on by Laeeth Isharc 2014 to convert to D.  Do whatever you want with the results: at your own risk be it.
 */
 ...
 */
extern (C) bool Dart_IsError(Dart_Handle handle);
 ...
 * Requires there to be a current isolate.
 */
extern (C) bool Dart_IsApiError(Dart_Handle handle);
 ...
 * Requires there to be a current isolate.
 */
extern (C) bool Dart_IsUnhandledExceptionError(Dart_Handle handle);
 ...
 * Requires there to be a current isolate.
 */
extern (C) bool Dart_IsCompilationError(Dart_Handle handle);
 ...
 * Requires there to be a current isolate.
 */
extern (C) bool Dart_IsFatalError(Dart_Handle handle);
 ...
 *   to Dart_ExitScope.
*/
extern (C) const char* Dart_GetError(Dart_Handle handle);

/**
 * Is this an error handle for an unhandled exception?
 */
extern (C) bool Dart_ErrorHasException(Dart_Handle handle);

/**
 * Gets the exception Object from an unhandled exception error handle.
 */
extern (C) Dart_Handle Dart_ErrorGetException(Dart_Handle handle);

/**
 * Gets the stack trace Object from an unhandled exception error handle.
 */
extern (C) Dart_Handle Dart_ErrorGetStacktrace(Dart_Handle handle);
 ...
 */
extern (C) Dart_Handle Dart_NewApiError(const char* error);
 ...
 */
extern (C) Dart_Handle Dart_NewUnhandledExceptionError(Dart_Handle exception);
 ...
 */
extern (C) Dart_Handle Dart_PropagateError(Dart_Handle handle);
...
extern (C) void _Dart_ReportErrorHandle(const char* file,
                                         int line,
 ...
 */
/+
template DART_CHECK_VALID(Dart_Handle handle)
{                                                                            
  Dart_Handle __handle = handle;                                             
  static if (Dart_IsError((__handle))) {
 //   _Dart_ReportErrorHandle(__FILE__, __LINE__,#handle, Dart_GetError(__handle));
    }
}
+/
 ...
 *   returned.
 */
extern (C) Dart_Handle Dart_ToString(Dart_Handle object);
 ...
 */
extern (C) bool Dart_IdentityEquals(Dart_Handle obj1, Dart_Handle obj2);
 ...
 */
extern (C) uint64_t Dart_IdentityHash(Dart_Handle obj);

/**
 * Allocates a handle in the current scope from a persistent handle.
 */
extern (C) Dart_Handle Dart_HandleFromPersistent(Dart_PersistentHandle object);

/**
 * Allocates a handle in the current scope from a weak persistent handle.
 */
extern (C) Dart_Handle Dart_HandleFromWeakPersistent(Dart_WeakPersistentHandle object);
 ...
 * Requires there to be a current isolate.
 */
extern (C) Dart_PersistentHandle Dart_NewPersistentHandle(Dart_Handle object);
 ...
 */
extern (C) void Dart_SetPersistentHandle(Dart_PersistentHandle obj1, Dart_Handle obj2);
 ...
 * Requires there to be a current isolate.
 */
extern (C) void Dart_DeletePersistentHandle(Dart_PersistentHandle object);
 ...
 */
extern (C) Dart_WeakPersistentHandle Dart_NewWeakPersistentHandle(Dart_Handle object,void* peer,intptr_t external_allocation_size, Dart_WeakPersistentHandleFinalizer callback);

extern (C) void Dart_DeleteWeakPersistentHandle(Dart_Isolate isolate,Dart_WeakPersistentHandle object);
 ...
 *   Otherwise, returns an error.
 */
extern (C) Dart_WeakPersistentHandle Dart_NewPrologueWeakPersistentHandle(Dart_Handle object,void* peer,intptr_t external_allocation_size,
 ...
 */
extern (C) Dart_WeakReferenceSetBuilder Dart_NewWeakReferenceSetBuilder();
 ...
 *   Otherwise, returns NULL.
 */
extern (C) Dart_WeakReferenceSet Dart_NewWeakReferenceSet(Dart_WeakReferenceSetBuilder set_builder,Dart_WeakPersistentHandle key,Dart_WeakPersistentHandle value);
 ...
 *   Otherwise, returns an error.
 */
extern (C) Dart_Handle Dart_AppendToWeakReferenceSet(Dart_WeakReferenceSet reference_set,Dart_WeakPersistentHandle key,Dart_WeakPersistentHandle value);
 ...
 *   Otherwise, returns an error.
 */
extern (C) Dart_Handle Dart_AppendKeyToWeakReferenceSet(Dart_WeakReferenceSet reference_set,Dart_WeakPersistentHandle key);
 ...
 *   Otherwise, returns an error.
 */
extern (C) Dart_Handle Dart_AppendValueToWeakReferenceSet(Dart_WeakReferenceSet reference_set,Dart_WeakPersistentHandle value);
 ...
 */
extern (C) const char* Dart_VersionString();
 ...
 */
extern (C) alias Dart_IsolateCreateCallback = Dart_Isolate function(const char* script_uri,const char* main,const char* package_root,void* callback_data,char** error);
 ...
 */
extern (C) alias Dart_IsolateInterruptCallback = bool function();
 ...
 */
extern (C) alias Dart_IsolateUnhandledExceptionCallback = void function(Dart_Handle error);
 ...
 *
 */
extern (C) alias Dart_IsolateShutdownCallback= void function(void* callback_data);
 ...
 *
 */
extern (C) alias Dart_FileOpenCallback = void function(const char* name, bool write);

extern (C) alias Dart_FileReadCallback = void function(const uint8_t** data,intptr_t* file_length,void* stream);

extern (C) alias  Dart_FileWriteCallback = void function(const void* data,intptr_t length,void* stream);

extern (C) alias Dart_FileCloseCallback= void function(void* stream);

extern (C) alias Dart_EntropySource = bool function(uint8_t* buffer, intptr_t length);
 ...
 */
extern (C) bool Dart_SetVMFlags(int argc, const char** argv);

/**
 * Returns true if the named VM flag is set.
 */
extern (C) bool Dart_IsVMFlagSet(const char* flag_name);
 ...
 */
extern (C) Dart_Isolate Dart_CreateIsolate(const char* script_uri,const char* main,const uint8_t* snapshot,void* callback_data,char** error);
 ...
 * Requires there to be a current isolate.
 */
extern (C) void Dart_ShutdownIsolate();
 ...
 */
extern (C) void* Dart_IsolateData(Dart_Isolate isolate);
 ...
 */
extern (C) Dart_Handle Dart_DebugName();
 ...
 * Requires there to be no current isolate.
 */
extern (C) void Dart_EnterIsolate(Dart_Isolate isolate);
 ...
 */
extern (C) void Dart_IsolateBlocked();

/**
 * Notifies the VM that the current isolate is no longer blocked.
 */
extern (C) void Dart_IsolateUnblocked();
 ...
 * Requires there to be a current isolate.
 */
extern (C) void Dart_ExitIsolate();
 ...
 */
extern (C) Dart_Handle Dart_CreateSnapshot(uint8_t** buffer,intptr_t* size);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_CreateScriptSnapshot(uint8_t** buffer,intptr_t* size);
 ...
 */
extern (C) void Dart_InterruptIsolate(Dart_Isolate isolate);
 ...
 */
extern (C) bool Dart_IsolateMakeRunnable(Dart_Isolate isolate);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_HandleMessage();
 ...
 */
extern (C) bool Dart_HandleServiceMessages();
 ...
 *   error handle is returned.
 */
extern (C) Dart_Handle Dart_RunLoop();
/* TODO(turnidge): Should this be removed from the public api? */

/**
 * Gets the main port id for the current isolate.
 */
extern (C) Dart_Port Dart_GetMainPortId();
 ...
 */
extern (C) bool Dart_HasLivePorts();
 ...
 */
extern (C) bool Dart_Post(Dart_Port port_id, Dart_Handle object);

/**
 * Returns a new SendPort with the provided port id.
 */
extern (C) Dart_Handle Dart_NewSendPort(Dart_Port port_id);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_SendPortGetId(Dart_Handle port,
                                           Dart_Port* port_id);
 ...
 */
extern (C) uint8_t* Dart_ScopeAllocate(intptr_t size);
 ...
 */
extern (C) Dart_Handle Dart_Null();
 ...
 */
extern (C) Dart_Handle Dart_EmptyString();

/**
 * Is this object null?
 */
extern (C) bool Dart_IsNull(Dart_Handle object);
 ...
 */
extern (C) Dart_Handle Dart_ObjectEquals(Dart_Handle obj1,
                                          Dart_Handle obj2,
                                          bool* equal);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_ObjectIsType(Dart_Handle object,
                                          Dart_Handle type,
                                          bool* instanceof);
 ...
 */
extern (C) bool Dart_IsInstance(Dart_Handle object);
extern (C) bool Dart_IsNumber(Dart_Handle object);
extern (C) bool Dart_IsInteger(Dart_Handle object);
extern (C) bool Dart_IsDouble(Dart_Handle object);
extern (C) bool Dart_IsBoolean(Dart_Handle object);
extern (C) bool Dart_IsString(Dart_Handle object);
extern (C) bool Dart_IsStringLatin1(Dart_Handle object);  /* (ISO-8859-1) */
extern (C) bool Dart_IsExternalString(Dart_Handle object);
extern (C) bool Dart_IsList(Dart_Handle object);
extern (C) bool Dart_IsMap(Dart_Handle object);
extern (C) bool Dart_IsLibrary(Dart_Handle object);
extern (C) bool Dart_IsType(Dart_Handle handle);
extern (C) bool Dart_IsFunction(Dart_Handle handle);
extern (C) bool Dart_IsVariable(Dart_Handle handle);
extern (C) bool Dart_IsTypeVariable(Dart_Handle handle);
extern (C) bool Dart_IsClosure(Dart_Handle object);
extern (C) bool Dart_IsTypedData(Dart_Handle object);
extern (C) bool Dart_IsByteBuffer(Dart_Handle object);
extern (C) bool Dart_IsFuture(Dart_Handle object);
 ...
 *   error handle is returned.
 */
extern (C) Dart_Handle Dart_InstanceGetType(Dart_Handle instance);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_IntegerFitsIntoInt64(Dart_Handle integer,
                                                  bool* fits);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_IntegerFitsIntoUint64(Dart_Handle integer,
                                                   bool* fits);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewInteger(int64_t value);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewIntegerFromHexCString(const char* value);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_IntegerToInt64(Dart_Handle integer,
                                            int64_t* value);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_IntegerToUint64(Dart_Handle integer,
                                             uint64_t* value);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_IntegerToHexCString(Dart_Handle integer,
                                                 const char** value);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewDouble(double value);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_DoubleValue(Dart_Handle double_obj, double* value);
 ...
 */
extern (C) Dart_Handle Dart_True();
 ...
 */
extern (C) Dart_Handle Dart_False();
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewBoolean(bool value);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_BooleanValue(Dart_Handle boolean_obj, bool* value);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_StringLength(Dart_Handle str, intptr_t* length);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewStringFromCString(const char* str);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewStringFromUTF8(const uint8_t* utf8_array,
                                               intptr_t length);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewStringFromUTF16(const uint16_t* utf16_array,
                                                intptr_t length);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewStringFromUTF32(const int32_t* utf32_array,
                                                intptr_t length);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewExternalLatin1String(
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewExternalUTF16String(const uint16_t* utf16_array,
                                                    intptr_t length,
                                                    void* peer,
                                                    Dart_PeerFinalizer cback);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_StringToCString(Dart_Handle str,
                                             const char** cstr);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_StringToUTF8(Dart_Handle str,
                                          uint8_t** utf8_array,
                                          intptr_t* length);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_StringToLatin1(Dart_Handle str,
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_StringToUTF16(Dart_Handle str,
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_StringStorageSize(Dart_Handle str, intptr_t* size);
 ...
 *
 */
extern (C) Dart_Handle Dart_MakeExternalString(Dart_Handle str,
                                                void* array,
                                                intptr_t length,
                                                void* peer,
                                                Dart_PeerFinalizer cback);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_StringGetProperties(Dart_Handle str,
                                                 intptr_t* char_size,
                                                 intptr_t* str_len,
                                                 void** peer);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewList(intptr_t length);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_ListLength(Dart_Handle list, intptr_t* length);
 ...
 */
extern (C) Dart_Handle Dart_ListGetAt(Dart_Handle list,
                                       intptr_t index);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_ListSetAt(Dart_Handle list,
                                       intptr_t index,
                                       Dart_Handle value);
 ...
 * May generate an unhandled exception error.
 */
extern (C) Dart_Handle Dart_ListGetAsBytes(Dart_Handle list,
                                            intptr_t offset,
 ...
 * May generate an unhandled exception error.
 */
extern (C) Dart_Handle Dart_ListSetAsBytes(Dart_Handle list,
                                            intptr_t offset,
                                            uint8_t* native_array,
                                            intptr_t length);
 ...
 */
extern (C) Dart_Handle Dart_MapGetAt(Dart_Handle map, Dart_Handle key);
 ...
 *   Otherwise returns an error handle.
 */
extern (C) Dart_Handle Dart_MapContainsKey(Dart_Handle map, Dart_Handle key);
 ...
 *   error handle.
 */
extern (C) Dart_Handle Dart_MapKeys(Dart_Handle map);
 ...
 *   Dart_TypedData_Type.
 */
extern (C) Dart_TypedData_Type Dart_GetTypeOfTypedData(Dart_Handle object);
 ...
 */
extern (C) Dart_TypedData_Type Dart_GetTypeOfExternalTypedData(
    Dart_Handle object);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewTypedData(Dart_TypedData_Type type,
                                          intptr_t length);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewExternalTypedData(Dart_TypedData_Type type,
                                                  void* data,
                                                  intptr_t length);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_NewByteBuffer(Dart_Handle typed_data);
 ...
 *   Otherwise, returns an error handle.
 */
extern (C) Dart_Handle Dart_TypedDataAcquireData(Dart_Handle object,
 ...
 *   Otherwise, returns an error handle.
 */
extern (C) Dart_Handle Dart_TypedDataReleaseData(Dart_Handle object);
 ...
 *   an error handle.
 */
extern (C) Dart_Handle Dart_GetDataFromByteBuffer(Dart_Handle byte_buffer);
 ...
 *   error handle is returned.
 */
extern (C) Dart_Handle Dart_New(Dart_Handle type,
 ...
 *   error handle is returned.
 */
extern (C) Dart_Handle Dart_Allocate(Dart_Handle type);
 ...
 *   error handle is returned.
 */
extern (C) Dart_Handle Dart_AllocateWithNativeFields(
    Dart_Handle type,
 ...
 */
extern (C) Dart_Handle Dart_Invoke(Dart_Handle target,
                                    Dart_Handle name,
                                    int number_of_arguments,
                                    Dart_Handle* arguments);
 ...
 */
extern (C) Dart_Handle Dart_InvokeClosure(Dart_Handle closure,
                                           int number_of_arguments,
                                           Dart_Handle* arguments);
 ...
 *   occurs during execution, then an error handle is returned.
 */
extern (C) Dart_Handle Dart_InvokeConstructor(Dart_Handle object,
                                               Dart_Handle name,
                                               int number_of_arguments,
                                               Dart_Handle* arguments);
 ...
 */
extern (C) Dart_Handle Dart_GetField(Dart_Handle container,
                                      Dart_Handle name);
 ...
 */
extern (C) Dart_Handle Dart_SetField(Dart_Handle container,
                                      Dart_Handle name,
                                      Dart_Handle value);
 ...
 */
extern (C) Dart_Handle Dart_ThrowException(Dart_Handle exception);
 ...
 *   Otherwise the function does not return.
 */
extern (C) Dart_Handle Dart_RethrowException(Dart_Handle exception,
 ...
 */
extern (C) Dart_Handle Dart_CreateNativeWrapperClass(Dart_Handle library,
 ...
 */
extern (C) Dart_Handle Dart_GetNativeInstanceFieldCount(Dart_Handle obj,
                                                         int* count);
 ...
 * TODO(turnidge): Document.
 */
extern (C) Dart_Handle Dart_GetNativeInstanceField(Dart_Handle obj,
                                                    int index,
                                                    intptr_t* value);
 ...
 * TODO(turnidge): Document.
 */
extern (C) Dart_Handle Dart_SetNativeInstanceField(Dart_Handle obj,
                                                    int index,
                                                    intptr_t value);
 ...
 */
extern (C) void* Dart_GetNativeIsolateData(Dart_NativeArguments args);
...
{
  auto BITMASK=((1 << size) - 1);
}

template DART_NATIVE_ARG_DESCRIPTOR(type, position)
{
  auto DART_NATIVE_ARG_DESCRIPTOR=(((type & BITMASK(kNativeArgTypeSize)) << kNativeArgTypePos) | (position & BITMASK(kNativeArgNumberSize)));
}
 ...
 */
extern (C) Dart_Handle Dart_GetNativeArguments(Dart_NativeArguments args,int num_arguments,const Dart_NativeArgument_Descriptor* arg_descriptors,
 ...
 */
extern (C) Dart_Handle Dart_GetNativeArgument(Dart_NativeArguments args,int index);
/* TODO(turnidge): Specify the behavior of an out-of-bounds access. */

/**
 * Gets the number of native arguments.
 */
extern (C) int Dart_GetNativeArgumentCount(Dart_NativeArguments args);
 ...
 *   'field_values' array.
 */
extern (C) Dart_Handle Dart_GetNativeFieldsOfArgument(Dart_NativeArguments args,int arg_index,int num_fields,intptr_t* field_values);

/**
 * Gets the native field of the receiver.
 */
extern (C) Dart_Handle Dart_GetNativeReceiver(Dart_NativeArguments args,intptr_t* value);
 ...
 */
extern (C) Dart_Handle Dart_GetNativeStringArgument(Dart_NativeArguments args,int arg_index,void** peer);
 ...
 */
extern (C) Dart_Handle Dart_GetNativeIntegerArgument(Dart_NativeArguments args,int index,int64_t* value);
 ...
 * \return Success if no error occurs. Otherwise returns an error handle.
 */
extern (C) Dart_Handle Dart_GetNativeBooleanArgument(Dart_NativeArguments args,int index,bool* value);
 ...
 * \return Success if no error occurs. Otherwise returns an error handle.
 */
extern (C) Dart_Handle Dart_GetNativeDoubleArgument(Dart_NativeArguments args,int index,double* value);

/**
 * Sets the return value for a native function.
 */
extern (C) void Dart_SetReturnValue(Dart_NativeArguments args,Dart_Handle retval);

extern (C) void Dart_SetWeakHandleReturnValue(Dart_NativeArguments args,Dart_WeakPersistentHandle rval);

extern (C) void Dart_SetBooleanReturnValue(Dart_NativeArguments args,bool retval);

extern (C) void Dart_SetIntegerReturnValue(Dart_NativeArguments args,int64_t retval);

extern (C) void Dart_SetDoubleReturnValue(Dart_NativeArguments args,double retval);

/**
 * A native function.
 */
extern (C) alias Dart_NativeFunction=void function(Dart_NativeArguments arguments);
 ...
 */
extern (C) alias Dart_NativeEntryResolver= Dart_NativeFunction function(Dart_Handle name,int num_of_arguments,bool* auto_setup_scope);
 ...
 */
extern (C) alias Dart_EnvironmentCallback=  Dart_Handle function(Dart_Handle name);
 ...
 */
extern (C) Dart_Handle Dart_SetEnvironmentCallback(Dart_EnvironmentCallback callback);
...
/* TODO(turnidge): Document. */
extern (C) alias Dart_LibraryTagHandler= Dart_Handle function(Dart_LibraryTag tag,Dart_Handle library,Dart_Handle url);
 ...
 * TODO(turnidge): Document.
 */
extern (C) Dart_Handle Dart_SetLibraryTagHandler(Dart_LibraryTagHandler handler);
 ...
 */
extern (C) Dart_Handle Dart_LoadScript(Dart_Handle url,Dart_Handle source,intptr_t line_offset,intptr_t col_offset);
 ...
 */
extern (C) Dart_Handle Dart_LoadScriptFromSnapshot(const uint8_t* buffer,intptr_t buffer_len);
 ...
 */
extern (C) Dart_Handle Dart_RootLibrary();
 ...
 *   Otherwise an error handle is returned.
 */
extern (C) Dart_Handle Dart_GetType(Dart_Handle library,Dart_Handle class_name,intptr_t number_of_type_arguments,Dart_Handle* type_arguments);
 ...
 *   returned. Otherwise an error handle is returned.
 */
extern (C) Dart_Handle Dart_GetClass(Dart_Handle library,
                                      Dart_Handle class_name);
 ...
 */
extern (C) Dart_Handle Dart_LibraryUrl(Dart_Handle library);

extern (C) Dart_Handle Dart_LookupLibrary(Dart_Handle url);
 ...
 * object is returned.
 */
extern (C) Dart_Handle Dart_LibraryHandleError(Dart_Handle library,Dart_Handle error);


extern (C) Dart_Handle Dart_LoadLibrary(Dart_Handle url,Dart_Handle source,intptr_t line_offset,intptr_t column_offset);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_LibraryImportLibrary(Dart_Handle library,Dart_Handle dartimport,Dart_Handle prefix);
 ...
 * \return A valid handle if no error occurs during the operation.
 */
extern (C) Dart_Handle Dart_LoadSource(Dart_Handle library,Dart_Handle url,Dart_Handle source,intptr_t line_offset,intptr_t column_offset);
 ...
 */
extern (C) Dart_Handle Dart_LibraryLoadPatch(Dart_Handle library,Dart_Handle url,Dart_Handle patch_source);
 ...
 */
extern (C) Dart_Handle Dart_FinalizeLoading(bool complete_futures);
 ...
 *   bool.
 */
extern (C) Dart_Handle Dart_GetPeer(Dart_Handle object, void** peer);
 ...
 *   bool.
 */
extern (C) Dart_Handle Dart_SetPeer(Dart_Handle object, void* peer);
 ...
 */
extern (C) Dart_Isolate Dart_GetServiceIsolate(void* callback_data);
 ...
 */
extern (C) bool Dart_IsServiceRunning();
 ...
 */
extern (C) alias Dart_ServiceRequestCallback= const char* function(const char* name,const char** arguments,intptr_t num_arguments,const char** option_keys,const char** option_values,
  intptr_t num_options,void* user_data);
 ...
 */
extern (C) void Dart_RegisterIsolateServiceRequestCallback(const char* name,Dart_ServiceRequestCallback callback,void* user_data);
 ...
 * last callback registered will be remembered.
 */
extern (C) void Dart_RegisterRootServiceRequestCallback(const char* name,Dart_ServiceRequestCallback callback,void* user_data);
